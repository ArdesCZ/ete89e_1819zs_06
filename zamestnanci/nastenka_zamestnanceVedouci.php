        ...
        <body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <span class="glyphicon glyphicon-vedouci"></span>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-6">            
                            <div class="business-card text-center">
                                <div class="media">
                                    <?php
                                    $dotazFoto = mysqli_query($spojeni, "select foto from uzivatele where uzivatele.uzivJM = '$ved'");
                                    ...
                                    <div class="media-body">
                                        <h2 class="media-heading">
                                            <?php
                                            $dotazJmeno = mysqli_query($spojeni, "select concat(jmeno, ' ', prijmeni) as jmenoPrij from uzivatele where uzivatele.uzivJM = '$ved'");
                                        ...
                                        <div class="job">
                                            <?php
                                            $dotazPozice = mysqli_query($spojeni, "select pozice from uzivatele where uzivatele.uzivJM = '$ved'");
                                        ...
                                        <div class="age"> Věk: 
                                            <?php
                                            $dotazVek = mysqli_query($spojeni, "select vek from uzivatele where uzivatele.uzivJM = '$ved'");
                                        ...
                                        <div class="mail">
                                            <a href="mailto:mala@gmail.com">
                                                <?php
                                                $dotazMail = mysqli_query($spojeni, "select email from uzivatele where uzivatele.uzivJM = '$ved'");
                ...
                <div class="row justify-content-center"> 
                    <div class="col-md-8" id="table">
                        <table class="table table-bordered table-striped table-hover bg-light text-center">
                            ...
                            <tbody>
                                <?php
                                $dotazTabu = mysqli_query($spojeni, "select * from dochazka join uzivatele on dochazka.id_uzivatele = uzivatele.idUzivatel where uzivatele.uzivJM = '$ved'");
            ...
            <script type="text/javascript">
                                        ...
                                        function casovac() {
                                            ...
                                            terminOD = h + ":" + m + ":" + s;
                                            document.cookie = "zacalVedOD=" + (terminOD);
                                            ...
                                            function hodinovyCas() {
                                                ...
                                                odpracovanyCas = i+1;
                                                document.cookie = "odpraovanoVedC=" + odpracovanyCas;
            ...
            if (@$_POST['tlacitko2']) {
                ...
                $odpracovanoOD = $_COOKIE[zacalVedOD];
                $odpracovanoDO = date("H:i:s");
                $odpracovanoCelkem = $_COOKIE[odpraovanoVedC];
                $dotazNaId = mysqli_query($spojeni, "select uzivatele.idUzivatel from uzivatele where uzivatele.uzivJM = '$ved'");
