...
<html lang="en">
  ...
  <body>     
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-outline-primary text-white" href="./nastenka_zamestnance.php">Nástěka zamětnance</a>
              <span class="glyphicon glyphicon-home"></span>
            </li> 
    ...
    <main id='main'>
	   <div class="container">
	     <div class="row">
            <div class="col align-self-center"><h1>Vítejte v uživatelské části aplikace! </h1></div> 
